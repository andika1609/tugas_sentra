...
cek_login();
$sql = "SELECT `input_aspirasi`.`id_pelaporan`,`penduduk`.`nama_penduduk`, `input_aspirasi`.`jenis_aspirasi`, `input_aspirasi`.`laporan`,`input_aspirasi`.`waktu_laporan`,`status_aspirasi`.`status`,`input_aspirasi`.`gambar`, `input_aspirasi`.`id_pelapor` FROM `input_aspirasi`,`penduduk`,`status_aspirasi` WHERE `input_aspirasi`.`id_pelapor`=`penduduk`.`id_penduduk` AND `input_aspirasi`.`id_pelaporan`=`status_aspirasi`.`id_laporan` AND `status_aspirasi`.`id_status`!=3;";
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="view-selesai.php">Selesai</a>
                        </li>
                    </ul>
                    <!-- <form class="d-flex">
                    ...
                    <div class="mb-2 mb-lg-0">
                        <a href="form.php" class="text-decoration-none">
                    ...
                    <table>
                        ...
                        <tr id="review_<?= $id ?>">
                            <td colspan="3" class="mt-1">
                                <textarea class="ps-1" name="" id="" placeholder="Masukan ulasan"></textarea>
                            </td>
                        </tr>
                    </table>
                </div>
